...
import numpy as np
df = pd.read_csv("C:\\Users\\admin\\sysn=2.csv")
...
oecd_bli = oecd_bli.drop('Label',axis=1)
...
for j in range(0,len(idx)):
    ytr.append(oecd_bli.iloc[j]['Label'])
    
    
gen_examples['Label']= ytr
gen_examples.to_csv("malganapi.csv")
